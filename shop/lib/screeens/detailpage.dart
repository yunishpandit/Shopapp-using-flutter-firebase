...
import 'package:shop/screeens/fullimage.dart';
...
class _DetailpageState extends State<Detailpage> {
  ...
  Widget build(BuildContext context) {
    ...
    final count1 = int.parse(widget.data["price"]) * count;
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
      ),
      bottomSheet: Row(
        children: [
          InkWell(
            onTap: () {
              Provider.of<Firebaseoperation>(context, listen: false)
                  .determinePosition();
              Provider.of<Firebaseoperation>(context, listen: false)
                  .oderofuseritems(context, widget.data["name"], count,
                      widget.data["image"], count1)
                  .whenComplete(() {
                Provider.of<Firebaseoperation>(context, listen: false)
          ...
          InkWell(
            onTap: () {
              Provider.of<Homehelper>(context, listen: false).getdata(
                  count1,
                  widget.data["name"],
                  widget.data["image"],
                  count,
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: ((context) =>
                                  Fullscreen(data: widget.data["images"][i]))));
                    },
                    child: Container(
